...
<body <?php body_class(); ?> <?php oceanwp_schema_markup( 'html' ); ?>>
	...
	<div id="outer-wrap" class="site clr">
		...
		<a class="skip-link screen-reader-text" href="#main"><?php oceanwp_theme_strings( 'owp-string-header-skip-link',  ); ?></a>
...
function contact_btn() {
	...
	// Code du bouton
	$string .= '<a href="http://localhost/projet10open/contact/" class="contact-btn">Nous contacter</a>';
